...
cfg = dict(
    ...
    MODEL=dict(
        name='mynet',
        input_channel=160,  # num_joints + 3 region map
    ...
    # 'Adam', 'SGD'
    # OPTIMIZER=dict(type='SGD', lr=1e-3, warmup_steps=100),
    OPTIMIZER=dict(type='Adam', lr=5e-4, warmup_steps=100, step_epoch=[170, 200], resume=False),
