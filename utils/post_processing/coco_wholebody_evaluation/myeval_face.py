...
class MYeval_face:
    ...
    def computeOks(self, imgId, catId):
        ...
        sigmas = np.array([0.42, 0.43, 0.44, 0.43, 0.4 , 0.35, 0.31, 0.25, 0.2 , 0.23, 0.29,
                           0.32, 0.37, 0.38, 0.43, 0.41, 0.45, 0.13, 0.12, 0.11, 0.11, 0.12,
                           0.12, 0.11, 0.11, 0.13, 0.15, 0.09, 0.07, 0.07, 0.07, 0.12, 0.09,
                           0.08, 0.16, 0.10, 0.17, 0.11, 0.09, 0.11, 0.09, 0.07, 0.13, 0.08,
                           0.11, 0.12, 0.10, 0.34, 0.08, 0.08, 0.09, 0.08, 0.08, 0.07, 0.10,
                           0.08, 0.09, 0.09, 0.09, 0.07, 0.07, 0.08, 0.11, 0.08, 0.08, 0.08,
                           0.10, 0.08]) / 10.0
        vars = (sigmas * 2)**2
        k = len(sigmas)
