...
# 各种IOU的介绍：https://www.bilibili.com/video/BV1yi4y1g7ro?p=4
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False):
    ...
    box1 = box1 if isinstance(box1, torch.Tensor) else torch.tensor(box1)
    box2 = box2.t() if isinstance(box2, torch.Tensor) else torch.tensor(box2).t()
