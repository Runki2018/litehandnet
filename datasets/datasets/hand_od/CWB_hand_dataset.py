...
from .od_dataset import ODdataset
from datasets.dataset_info.dataset_configs import coco_wholebody_hand_info


class HandCocoWholeBodyDataset(ODdataset):
            ...
            for obj in objs:
                for type in ['left', 'right']:
                    if obj[f'{type}hand_valid'] and max(
                        ...
                        center, scale = self._xywh2cs(*obj[f'{type}hand_box'][:4], 1.25)
