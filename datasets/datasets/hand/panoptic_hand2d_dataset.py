...
from datasets.dataset_info.dataset_configs import panoptic_info


class PanopticDataset(Kpt2dDataset):
    ...
    def __init__(self, data_cfg, pipeline, data_type='train'):
        ...
        super().__init__(data_cfg, pipeline, data_type, dataset_info=panoptic_info)
